import checkComplete from "./componentes/checkComplete.js";             //importar el script
import deleteIcon from "./componentes/deleteIcon.js";

(()=>{
const btn = document.querySelector('[data-form-btn]');                  //seleccion formulario
//console.log(btn);
...
/*const deleteIcon =()=>{                                              //es un componente creado
